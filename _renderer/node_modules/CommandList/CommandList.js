...
module.exports = class CommandList extends TabComponent {
  initCallback() {
    ...
    this.initTab('CommandTab', this.left)
  ...
  readyCallback() {
    AppEvent('newTab', { elem: this, name: 'Commands', priority: -70 })
  }
  ...
  newCommand(c) {
    ...
    if(!tab) {
      tab = { name: c.tab, instance: this.newElem(FlexBalanced, false, { basis: 12 }) }
    ...
    if(module) {
      ...
      tab.instance.newElem(require(module), true, { command: c, parent: this })
    }
    else {
      var p = tab.instance.newElem('p')
      var a = p.newElem('a')
