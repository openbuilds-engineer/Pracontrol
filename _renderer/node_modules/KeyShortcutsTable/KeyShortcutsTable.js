...
module.exports = class KeyShortcutsTable extends WebComponentAbstract {
  init() {
    ...
    self.on('defineShortcut', e => this.newShortcut(e.d))
    
    this.el = this.new(FlexBalanced)
  }
  
  readyCallback() {
    self.emit('newTab', { elem: this, name: 'Shortcuts', priority: 800 })
  }
  ...
  newShortcut(k) {
    ...
    if(!div) {
      ...
      var th = thead.new('tr').new('th', true, { colSpan: 2, textContent: k.cat })
