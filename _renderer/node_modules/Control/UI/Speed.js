...
module.exports = class Speed extends WebComponentAbstract {
  init() {
    ...
    this.new(AxisSettings, { opt: { name: 'Max acceleration by axis', gCode: 'M201' } })
    this.new(AxisSettings, { opt: { name: 'Max feedrate', gCode: 'M203' } })
    this.new(AxisSettings, { opt: { name: 'Axis steps per unit', gCode: 'M92' } })
  }
}
