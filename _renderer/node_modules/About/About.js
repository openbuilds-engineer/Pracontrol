...
::content {
  ...
  .logo {
    background: url('res/logo.svg') center center no-repeat;
...
<right>
  ...
  <p><a onclick="AppEvent('focusTab', 1)" class="button">Continue →</a></p>
</right>
...
module.exports = class About extends WebComponentAbstract {
  ...
  readyCallback() {
    AppEvent('newTab', { elem: this, name: 'PraControl', priority: -100 })
  }
}
