...
<left class="column-width-gold">
  ...
  <p>Contributors: ${app.package.contributors.map(e => `<a href="${e.url || 'mailto://' + e.email}">${e.name}</a>`).join(', ')}</p>
  <p><a href="${app.package.homepage}">website</a> | <a href="${app.package.repository.url}">GitHub</a></p>
  <p><a href="${app.package.donate}" class="button">Buy a beer 🍺</a></p>
</div>
`
...
module.exports = class About extends WebComponentAbstract {
  init() {
    ...
    self.emit('newTab', { el: this, name: 'About', priority: 1000 })
  }
}
