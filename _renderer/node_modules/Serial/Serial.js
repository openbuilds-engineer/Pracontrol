...
module.exports = class Serial extends WebComponentAbstract {
  initCallback() {
    ...
    this.connectForm = this.newElem(require('./ConnectForm'))
    
    this.serial = null
    this.buffer = this.newElem(require('./SerialBuffer'), false, { parent: this })
    this.status = this.newElem(require('./SerialStatus'), false, { parent: this })
  ...
  readyCallback() {
    ...
    AppEvent('newDashboard', { elem: this })
  }
