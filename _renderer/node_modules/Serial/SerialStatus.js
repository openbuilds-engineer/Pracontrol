...
module.exports = class SerialStatus extends WebComponentAbstract {
  init() {
    this.new(require('./SerialStatusCount'), { serial: this.serial }, false)
    ...
    this.busyStatus = this.new('status', { textContent: '●' })
