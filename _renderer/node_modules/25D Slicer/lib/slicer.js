...
module.exports = class Slicer25D_Slicer extends WebComponentAbstract {
  init() {
    ...
    this.slider.style.marginBottom = '0.5rem'
  ...
  startWorker() {
    ...
    this.w = new Worker(filepath.join(__dirname, 'worker.js'))
    this.w.postMessage({ func: 'importScripts', arg: [filepath.join(__dirname, 'spiral-flood-fill.js')] })
  ...
  sliceDone() {
    ...
    this.w.postMessage({ func: 'gCode', arg: [ this.parent.ser.powerCmd, this.parent.ser.fidelity, this.parent.ser.pass ] })
