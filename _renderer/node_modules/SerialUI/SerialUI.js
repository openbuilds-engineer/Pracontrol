...
module.exports = class SerialUI extends WebComponentAbstract {
  init() {
    this.new(require('./Form'), {}, false)
    this.new(require('./Count'), {}, false)
    ...
    self.on('deviceReady', e => this.textStatus.textContent = 'Ready')
    ...
    self.on('deviceReady', e => { s = -1; clearInterval(interval); count(); })
    ...
    self.on('deviceReady', e => busyStatus.classList.add('enabled'))
