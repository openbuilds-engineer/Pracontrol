...
module.exports = class Developer extends WebComponentAbstract {
  ...
  init() {
    ...
    this.newElem('div').innerHTML = info
    this.newElem(require('./AppEventTable.js'))
  }
  ...
  turnOn() {
    ...
    document.body.newElem('rembased_grid')
  }
}
