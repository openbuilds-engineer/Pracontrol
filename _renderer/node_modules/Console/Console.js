...
module.exports = class Console extends WebComponentAbstract {
  init() {
    ...
    this.input = this.new('input', true, { placeholder: 'Send command' })
    ...
    defineEvent('serialEcho', 'Device sends echo message', 'Console', "''")
    defineEvent('serialOk', 'Device sends ok message', 'Console', "''")
    ...
    setImmediate(() => self.emit('newTab', { elem: this, name: 'Console', priority: -80 }))
  }
