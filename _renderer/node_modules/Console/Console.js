...
module.exports = class Console extends WebComponentAbstract {
  init() {
    ...
    defineEvent('serialConfig', 'Device sends config message, listen only', 'Console', `''`)
    ...
    this.on('tabFocus', e => { this.input.focus(); this.scrollDown(); })
