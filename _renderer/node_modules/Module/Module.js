...
module.exports = class Module extends WebComponentAbstract {
  init() {
    ...
    this.textarea = left.new('p').new('textarea', true, { value: this.ser.conf, placeholder: 'Module names' })
...
<ol>
  ...
  <li>Spread the word!</li>
    ...
    var p = this.new('p', true, { textContent: 'Open your require path: ' + this.userModulesDir })
  ...
  readyCallback() {
    self.emit('newTab', { elem: this, name: 'Modules', priority: 850 })
  }
}
