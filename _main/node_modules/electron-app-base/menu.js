...
var menu = [
  ...
  },
  {
    ...
    submenu: [
      { label: 'Website', click: item => require('electron').shell.openExternal(pack.homepage) },
      { label: 'GitHub', click: item => require('electron').shell.openExternal(pack.repository.url) },
    ]
  },
]
